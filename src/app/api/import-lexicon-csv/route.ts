    ...
    try {
        ...
        if (!fs.existsSync(CSV_FILE_PATH)) {
            ...
            for (const row of csvRows) {
                ...
                const csvSubmissionData: Omit<UserSubmissionBase<UserSubmissionBase<NewEntrySuggestionData>>, 'id' | 'status' | 'timestamp'> = {
                    submissionType: 'new',
                    data: {
                        id: 0, // Placeholder, will be generated by the database
                        submissionType: 'new',
                        data: {
                        ...
                        status: 'pending', // Placeholder, will be set to 'pending' by createSubmissionInDatabase
